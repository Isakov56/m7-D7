  ...
  fetchPostImage = async (id) => {
    try {
      let response = await fetch(
        `${process.env.REACT_APP_BE_URL}/experience/${id}/picture`,
        {
          method: "POST",
    ...
    try {
      ...
      if (this.props.editExp.experience._id) {
        response = await fetch(
          `${process.env.REACT_APP_BE_URL}/experience/${this.props.editExp.experience._id}`,
          {
            method: "PUT",
        ...
        response = await fetch(
          `${process.env.REACT_APP_BE_URL}/experience/${this.props.id}`,
          {
            method: "POST",
            body: JSON.stringify(this.state.experience),
